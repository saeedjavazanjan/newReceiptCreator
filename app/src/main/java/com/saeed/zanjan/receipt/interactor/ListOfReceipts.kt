   ...
   fun filterReceipts(
       ...
       try {
           when (receiptCategory) {
               0 -> {
                   //repair
                   val result=receiptDao.filterRepairs(status)
                   val list= mutableListOf<GeneralReceipt>()
                   result.forEach {rec->
                       list.add(generalMapper.mapFromRepairsEntity(rec))
                   }
               ...
               3 -> {
                   //tailoring
                   val result=receiptDao.filterTailoring(status)
                   val list= mutableListOf<GeneralReceipt>()
                   result.forEach {rec->
                       list.add(generalMapper.mapFromTailoringEntity(rec))
                   }
               ...
               4 -> {
                   //jewelry
                   val result=receiptDao.filterJewelry(status)
                   val list= mutableListOf<GeneralReceipt>()
                   result.forEach {rec->
                       list.add(generalMapper.mapFromJewelryEntity(rec))
                   }
               ...
               5 -> {
                   //photo
                   val result=receiptDao.filterPhotography(status)
                   val list= mutableListOf<GeneralReceipt>()
                   result.forEach {rec->
                       list.add(generalMapper.mapFromPhotographyEntity(rec))
                   }
               ...
               6 -> {
                   //laundry
                   val result=receiptDao.filterLaundry(status)
                   val list= mutableListOf<GeneralReceipt>()
                   result.forEach {rec->
                       list.add(generalMapper.mapFromLaundryEntity(rec))
                   }
               ...
               7 -> {
                   //confectionery
                   val result=receiptDao.filterConfectionery(status)
                   val list= mutableListOf<GeneralReceipt>()
                   result.forEach {rec->
                       list.add(generalMapper.mapFromConfectioneryEntity(rec))
                   }
               ...
               8 -> {
                   //otherJobs
                   val result=receiptDao.filterOtherJobs(status)
                   val list= mutableListOf<GeneralReceipt>()
                   result.forEach {rec->
                       list.add(generalMapper.mapFromOtherJobsEntity(rec))
                   }
